...
## Corpus Check
- 30 files · ~21,792 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 314 nodes · 527 edges · 19 communities (15 shown, 4 thin omitted)
...
Cohesion: 0.10
Nodes (22): FILE, forgetRepo(), KnownWorkspace, listKnownWorkspaces(), recordWorkspace(), writeAll(), alsoForget, alsoGraph (+14 more)

### Community 4 - "clients.ts"
Cohesion: 0.19
Nodes (19): ClientDef, CLIENTS, ClientState, jsonPath(), PatchResult, patchWorkspace(), readAllClients(), readClient() (+11 more)
...
### Community 15 - "ls.ts"
Cohesion: 0.08
Nodes (43): bad(), blue, bold, cmd(), cyan, dim, green, heading() (+35 more)
...
- **Why does `wireRepo()` connect `clients.ts` to `index.ts`, `hookwire.ts`, `smoke-uninstall.ts`, `ls.ts`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `SupabaseStore` connect `store.ts` to `index.ts`, `LocalStore`?**
